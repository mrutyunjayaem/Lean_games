...
// 🔥 Your Firebase config (make sure env vars are set in Vercel)
...
export async function addPlayerToGame(gameId, playerName, playerId) {
  ...
  const role = roles[chosenTeam.playerCount];
